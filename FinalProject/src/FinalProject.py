...
def get_p_t_value_ranking_table(df, feature_names, response_name):
    ...
    p_out_df = p_out_df.sort_values("p-value", ascending=True)
...
def get_cv_scoring_table(
    df, selected_feature_names, response_name, model_types, scoring_types, n_cv=5
):
    print("Calculating Cross Validation Scoring table")
...
def get_split_scoring_table(
    ...
    print("Calculating Split Scoring table")
    # df_training = df.loc[df['game_date'] <= '2010-08-20']
    # df_test = df.loc[df['game_date'] > '2010-08-20']
    train_x = df_train[selected_feature_names]
    train_y = df_train[response_name]
    test_x = df_test[selected_feature_names]
    test_y = df_test[response_name]
    ...
    for model_type in model_types:
        ...
        if model_type == "logistic_regression":
            model = LogisticRegression(solver="lbfgs", max_iter=1000).fit(
                train_x, train_y
            )
        elif model_type == "random_forest":
            ...
            decision_tree_grid_search.fit(X=train_x, y=train_y)
            model = decision_tree_grid_search.best_estimator_
        else:
            continue
        ...
        for scoring_type in scoring_types:
            ...
            # ["accuracy", "roc_auc", "average_precision", "precision"]
            ...
            elif scoring_type == "average_precision":
                score = average_precision_score(
                    test_y, model.predict_proba(test_x)[:, 1]
                )
            elif scoring_type == "precision":
                score = precision_score(test_y, model.predict(test_x))
            else:
                continue
...
def main():
    feature_names = [
        "home_final_score_avg_100",
        "away_final_score_avg_100",
        "home_off_batting_avg_100",
        "away_off_batting_avg_100",
        "home_def_batting_avg_100",
        "away_def_batting_avg_100",
        "home_off_plateapperance_strikeout_100",
        "away_off_plateapperance_strikeout_100",
        "home_def_plateapperance_strikeout_100",
        "away_def_plateapperance_strikeout_100",
        "home_off_single_avg_100",
        "away_off_single_avg_100",
        "home_def_single_avg_100",
        "away_def_single_avg_100",
        "home_off_double_avg_100",
        "away_off_double_avg_100",
        "home_def_double_avg_100",
        "away_def_double_avg_100",
        "home_off_triple_avg_100",
        "away_off_triple_avg_100",
        "home_def_triple_avg_100",
        "away_def_triple_avg_100",
        "home_off_walk_to_strikeout_avg_100",
        "away_off_walk_to_strikeout_avg_100",
        "home_def_walk_to_strikeout_avg_100",
        "away_def_walk_to_strikeout_avg_100",
        "home_off_ground_to_flyout_avg_100",
        "away_off_ground_to_flyout_avg_100",
        "home_def_ground_to_flyout_avg_100",
        "away_def_ground_to_flyout_avg_100",
        "home_off_on_base_percentage_avg_100",
        "away_off_on_base_percentage_avg_100",
        "home_def_on_base_percentage_avg_100",
        "away_def_on_base_percentage_avg_100",
        "home_off_slug_percentage_avg_100",
        "away_off_slug_percentage_avg_100",
        "home_def_slug_percentage_avg_100",
        "away_def_slug_percentage_avg_100",
        "home_off_on_base_plus_slug_avg_100",
        "away_off_on_base_plus_slug_avg_100",
        "home_def_on_base_plus_slug_avg_100",
        "away_def_on_base_plus_slug_avg_100",
        "home_home_win_percentage_100",
        "away_home_win_percentage_100",
        "home_away_win_percentage_100",
        "away_away_win_percentage_100",
        "home_win_percentage_100",
        "away_win_percentage_100",
        "home_final_score_avg_20",
        "away_final_score_avg_20",
        "home_off_batting_avg_20",
        "away_off_batting_avg_20",
        "home_def_batting_avg_20",
        "away_def_batting_avg_20",
        "home_off_plateapperance_strikeout_20",
        "away_off_plateapperance_strikeout_20",
        "home_def_plateapperance_strikeout_20",
        "away_def_plateapperance_strikeout_20",
        "home_off_single_avg_20",
        "away_off_single_avg_20",
        "home_def_single_avg_20",
        "away_def_single_avg_20",
        "home_off_double_avg_20",
        "away_off_double_avg_20",
        "home_def_double_avg_20",
        "away_def_double_avg_20",
        "home_off_triple_avg_20",
        "away_off_triple_avg_20",
        "home_def_triple_avg_20",
        "away_def_triple_avg_20",
        "home_off_walk_to_strikeout_avg_20",
        "away_off_walk_to_strikeout_avg_20",
        "home_def_walk_to_strikeout_avg_20",
        "away_def_walk_to_strikeout_avg_20",
        "home_off_ground_to_flyout_avg_20",
        "away_off_ground_to_flyout_avg_20",
        "home_def_ground_to_flyout_avg_20",
        "away_def_ground_to_flyout_avg_20",
        "home_off_on_base_percentage_avg_20",
        "away_off_on_base_percentage_avg_20",
        "home_def_on_base_percentage_avg_20",
        "away_def_on_base_percentage_avg_20",
        "home_off_slug_percentage_avg_20",
        "away_off_slug_percentage_avg_20",
        "home_def_slug_percentage_avg_20",
        "away_def_slug_percentage_avg_20",
        "home_off_on_base_plus_slug_avg_20",
        "away_off_on_base_plus_slug_avg_20",
        "home_def_on_base_plus_slug_avg_20",
        "away_def_on_base_plus_slug_avg_20",
        "home_home_win_percentage_20",
        "away_home_win_percentage_20",
        "home_away_win_percentage_20",
        "away_away_win_percentage_20",
        "home_win_percentage_20",
        "away_win_percentage_20",
    ]
    ...
    db_user = "root"
    db_pass = "example"  # pragma: allowlist secret
    db_host = "db:3306"
    db_database = "baseball"
    connect_string = f"mysql+pymysql://{db_user}:{db_pass}@{db_host}/{db_database}"  # pragma: allowlist secret
    db_connection = sqlalchemy.create_engine(connect_string)
    query = "select * from temp_for_training"
    df = pd.read_sql(sql=query, con=db_connection)
    # db_connection.close()
    df_train = df.loc[df["game_date"] <= "2010-08-20"]
    df_test = df.loc[df["game_date"] > "2010-08-20"]

    df = df[feature_names + [response_name]].fillna(0).astype(np.float32)
    df_train = df_train[feature_names + [response_name]].fillna(0).astype(np.float32)
    df_test = df_test[feature_names + [response_name]].fillna(0).astype(np.float32)
    ...
    cv_scoring_table_html = get_cv_scoring_table(
        df, selected_feature_names, response_name, model_types, scoring_types
    )

    split_scoring_table_html = get_split_scoring_table(
        df_train,
        df_test,
        selected_feature_names,
        response_name,
    ...
    html = f"""
        <html>
            <head></head>
            <body>
                <h2>P-Value Ranking (Sorted by p-value ASC)</h2>
                {p_value_ranking_table_html}
                ...
                {cv_scoring_table_html}
                <h3>Split by Date 2010-08-20</h3>
                {split_scoring_table_html}
